...
def create_dataset(cfg: CfgNode):
    ...
    elif cfg.dataset == "havid_lh_v0":
        map_fname = './data/havid/task_mapping.txt'
        dataset_path = './data/havid/'
        train_split_fname = f'./data/havid/splits/View0/lh_pt/train.{cfg.split}.bundle'
        test_split_fname = f'./data/havid/splits/View0/lh_pt/test.{cfg.split}.bundle'
        feature_path = './data/havid/features'
        feature_transpose = True
        if cfg.Loss.match == 'o2o':
            average_transcript_len = 6.9 
        bg_class = [27]
        groundTruth_path = os.path.join(dataset_path, 'groundTruth/View0/lh_pt')

    elif cfg.dataset == "havid_rh_v0":
        map_fname = './data/havid/task_mapping.txt'
        dataset_path = './data/havid/'
        train_split_fname = f'./data/havid/splits/View0/rh_pt/train.{cfg.split}.bundle'
        test_split_fname = f'./data/havid/splits/View0/rh_pt/test.{cfg.split}.bundle'
        feature_path = './data/havid/features'
        feature_transpose = True
        if cfg.Loss.match == 'o2o':
            average_transcript_len = 6.9 
        bg_class = [27]
        groundTruth_path = os.path.join(dataset_path, 'groundTruth/View0/rh_pt')

    elif cfg.dataset == "havid_lh_v1":
        map_fname = './data/havid/task_mapping.txt'
        dataset_path = './data/havid/'
        train_split_fname = f'./data/havid/splits/View1/lh_pt/train.{cfg.split}.bundle'
        test_split_fname = f'./data/havid/splits/View1/lh_pt/test.{cfg.split}.bundle'
        feature_path = './data/havid/features'
        feature_transpose = True
        if cfg.Loss.match == 'o2o':
            average_transcript_len = 6.9 
        bg_class = [27]
        groundTruth_path = os.path.join(dataset_path, 'groundTruth/View1/lh_pt')

    elif cfg.dataset == "havid_rh_v1":
        map_fname = './data/havid/task_mapping.txt'
        dataset_path = './data/havid/'
        train_split_fname = f'./data/havid/splits/View1/rh_pt/train.{cfg.split}.bundle'
        test_split_fname = f'./data/havid/splits/View1/rh_pt/test.{cfg.split}.bundle'
        feature_path = './data/havid/features'
        feature_transpose = True
        if cfg.Loss.match == 'o2o':
            average_transcript_len = 6.9 
        bg_class = [27]
        groundTruth_path = os.path.join(dataset_path, 'groundTruth/View1/rh_pt')

    elif cfg.dataset == "havid_lh_v2":
        map_fname = './data/havid/task_mapping.txt'
        dataset_path = './data/havid/'
        train_split_fname = f'./data/havid/splits/View2/lh_pt/train.{cfg.split}.bundle'
        test_split_fname = f'./data/havid/splits/View2/lh_pt/test.{cfg.split}.bundle'
        feature_path = './data/havid/features'
        feature_transpose = True
        if cfg.Loss.match == 'o2o':
            average_transcript_len = 6.9 
        bg_class = [27]
        groundTruth_path = os.path.join(dataset_path, 'groundTruth/View2/lh_pt')

    elif cfg.dataset == "havid_rh_v2":
        map_fname = './data/havid/task_mapping.txt'
        dataset_path = './data/havid/'
        train_split_fname = f'./data/havid/splits/View2/rh_pt/train.{cfg.split}.bundle'
        test_split_fname = f'./data/havid/splits/View2/rh_pt/test.{cfg.split}.bundle'
        feature_path = './data/havid/features'
        feature_transpose = True
        if cfg.Loss.match == 'o2o':
            average_transcript_len = 6.9 
        bg_class = [27]
        groundTruth_path = os.path.join(dataset_path, 'groundTruth/View2/rh_pt')
    
    elif cfg.dataset == "attach_lh":
        map_fname = './data/attach/raw_attach_dataset/mapping.txt'
        dataset_path = './data/attach/raw_attach_dataset/'
        train_split_fname = f'./data/attach/raw_attach_dataset/splits/left_hand/train.{cfg.split}.bundle'
        test_split_fname = f'./data/attach/raw_attach_dataset/splits/left_hand/test.{cfg.split}.bundle'
        feature_path = './data/attach/raw_attach_dataset/i3d_features'
        feature_transpose = True
        if cfg.Loss.match == 'o2o':
            average_transcript_len = 6.9 
        bg_class = [24]
        groundTruth_path = os.path.join(dataset_path, 'groundTruth_downsampled_trimmed/left_hand')

    elif cfg.dataset == "attach_rh":
        map_fname = './data/attach/raw_attach_dataset/mapping.txt'
        dataset_path = './data/attach/raw_attach_dataset/'
        train_split_fname = f'./data/attach/raw_attach_dataset/splits/right_hand/train.{cfg.split}.bundle'
        test_split_fname = f'./data/attach/raw_attach_dataset/splits/right_hand/test.{cfg.split}.bundle'
        feature_path = './data/attach/raw_attach_dataset/i3d_features'
        feature_transpose = True
        if cfg.Loss.match == 'o2o':
            average_transcript_len = 6.9 
        bg_class = [24]
        groundTruth_path = os.path.join(dataset_path, 'groundTruth_downsampled_trimmed/right_hand')
    ...
    if cfg.dataset in ['breakfast', '50salads', 'gtea', 'havid_lh_v0', 'havid_rh_v0', 'havid_lh_v1', 'havid_rh_v1', 'havid_lh_v2', 'havid_rh_v2']: 
