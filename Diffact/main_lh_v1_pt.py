...
if __name__ == '__main__':
    ...
    label_dir = os.path.join(root_data_dir, dataset_name, 'groundTruth/View1/lh_pt')
    ...
    train_video_list = np.loadtxt(os.path.join(
        root_data_dir, dataset_name, 'splits/View1/lh_pt', f'train.split{split_id}.bundle'), dtype=str)
    test_video_list = np.loadtxt(os.path.join(
        root_data_dir, dataset_name, 'splits/View1/lh_pt', f'test.split{split_id}.bundle'), dtype=str)
