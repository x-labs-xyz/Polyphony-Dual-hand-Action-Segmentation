...
parser.add_argument('--dataset', default="attach")
...
vid_list_file = "/home/hao/Polyphony/data/"+args.dataset+"/raw_attach_dataset/splits/right_hand/train.split"+args.split+".bundle"
vid_list_file_tst = "/home/hao/Polyphony/data/"+args.dataset+"/raw_attach_dataset/splits/right_hand/test.split"+args.split+".bundle"
features_path = "/home/hao/Polyphony/data/"+args.dataset+"/raw_attach_dataset/i3d_features/"
gt_path = "/home/hao/Polyphony/data/"+args.dataset+"/raw_attach_dataset/groundTruth_downsampled/right_hand/"

mapping_file = "/home/hao/Polyphony/data/"+args.dataset+"/raw_attach_dataset/mapping.txt"

model_dir = "./models/right_hand/"+args.dataset+"/split_"+args.split+"/stages_"+\
args.num_stages+"_layers_"+args.num_layers+"_fmaps_"+args.num_f_maps+"_dfsize_"+args.df_size
results_dir = "./results/right_hand/"+args.dataset+"/split_"+args.split+"/stages_"+\
args.num_stages+"_layers_"+args.num_layers+"_fmaps_"+args.num_f_maps+"_dfsize_"+args.df_size
...
if args.action == "train":
    ...
    print("Train::View0/lh_aa/"+args.dataset+"_split_"+args.split+"---stages_"+args.num_stages+
...
if args.action == "predict":
    ...
    print("Predict::View0/lh_aa/"+args.dataset+"_split_"+args.split+"---stages_"+args.num_stages+
        "_layers_"+args.num_layers+"_fmaps_"+args.num_f_maps+"_dfsize_"+args.df_size)
