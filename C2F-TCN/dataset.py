...
class AugmentDataset(torch.utils.data.Dataset):
    ...
    def make_data_set(self, fold_file_name):
        ...
        # print(label_name_to_label_id_dict)

        with open(self.args.label_id_csv, 'r') as input_file:
        ...
        for line in lines:
            ...
            if line:
                ...
                if len(parts) == 2:
                    id_, name = parts
                    label_id_to_label_name[int(id_)] = name
                    label_name_to_label_id_dict[name] = int(id_)
        # print(label_id_to_label_name)
        # print(label_name_to_label_id_dict)
