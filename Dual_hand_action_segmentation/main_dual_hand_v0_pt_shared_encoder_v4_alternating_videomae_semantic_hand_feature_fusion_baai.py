...
if __name__ == '__main__':
    ...
    feature_dir_lh = os.path.join(root_data_dir, dataset_name, 'videomae_features_concatenated_semantic_extend/baai/lh_v0')
    feature_dir_rh = os.path.join(root_data_dir, dataset_name, 'videomae_features_concatenated_semantic_extend/baai/rh_v0')
