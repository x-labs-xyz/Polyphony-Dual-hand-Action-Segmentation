...
from dual_hand_model_shared_encoder_v2_hand_specifc_feature_joint_action_consistency_loss import DualHandASDiffusionModel
...
if __name__ == '__main__':
    ...
    feature_dir_lh = os.path.join(root_data_dir, dataset_name, 'videomae_features_concatenated_semantic/alternating_dual_hand/MiniLM/lh_v0')
    feature_dir_rh = os.path.join(root_data_dir, dataset_name, 'videomae_features_concatenated_semantic/alternating_dual_hand/MiniLM/rh_v0')
    ...
    dual_hand_loss_weights = {
        ...
        'consistency_loss': 0.1,  # Start with 0.1, tune as needed
    }
