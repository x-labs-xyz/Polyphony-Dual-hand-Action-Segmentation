...
from dual_hand_model_shared_encoder_v2_hand_specifc_feature_hand_feature_fusion import DualHandASDiffusionModel
...
if __name__ == '__main__':
    ...
    feature_dir_lh = os.path.join(root_data_dir, dataset_name, 'videomae_features_semantic/MiniLM/left_hand')
    feature_dir_rh = os.path.join(root_data_dir, dataset_name, 'videomae_features_semantic/MiniLM/right_hand')
    label_dir_lh = os.path.join(root_data_dir, dataset_name, 'groundTruth_downsampled/left_hand')
    label_dir_rh = os.path.join(root_data_dir, dataset_name, 'groundTruth_downsampled/right_hand')
    ...
    train_video_list = np.loadtxt(os.path.join(
        root_data_dir, dataset_name, 'splits/left_hand', f'train.split{split_id}.bundle'), dtype=str)
    test_video_list = np.loadtxt(os.path.join(
        root_data_dir, dataset_name, 'splits/left_hand', f'test.split{split_id}.bundle'), dtype=str)
