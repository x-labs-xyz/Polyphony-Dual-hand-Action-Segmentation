...
class VideoClsDataset(Dataset):
    ...
    def __init__(self,
        ...
        # Correctly construct video paths with videos_train/videos_val subdirectory
        if self.mode == 'train':
            video_subdir = 'videos_train'
        else:  # validation or test
            video_subdir = 'videos_val'
        
        self.dataset_samples = list(
            cleaned[0].apply(lambda row: os.path.join(self.data_root, video_subdir, row)))
