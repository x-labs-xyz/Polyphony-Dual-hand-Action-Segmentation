...
def get_args():
    ...
    parser.add_argument('--rh_data_path', required=True, type=str, help='Right hand data path')
    parser.add_argument('--rh_data_root', required=True, type=str, help='Right hand data root')
