...
if __name__ == "__main__":
    ...
    config = {
        ...
        'feature_path': '/home/hao/Polyphony/VideoMAEv2/output/frame_features/dual-hand_features/shared_features',
        'annotation_path': '/home/hao/Polyphony/data/havid/groundTruth/View0/lh_pt',
        'save_dir': './havid_checkpoints/dual_hand/MiniLM/lh_v0',
        'save_feature_dir': './havid_enhanced_features/dual_hand/MiniLM/lh_v0',
        'batch_size': 4,  # Increased batch size for better gradients
        'learning_rate': 3e-4,
        'num_epochs': 100,
        'device': 'cuda' if torch.cuda.is_available() else 'cpu',
        'visual_dim': 768,  # VideoMAE feature dimension
        'semantic_dim': 384,  # sentence-transformers/all-MiniLM-L6-v2 dimension
        'tcn_hidden_dims': [128, 64], # [640, 512, 384], # [512, 512, 256],
        'max_frames': 3000,
