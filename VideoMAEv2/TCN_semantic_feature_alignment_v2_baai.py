...
class SemanticFeatureAlignmentModel(nn.Module):
    ...
    def __init__(
        ...
        tcn_hidden_dims: List[int] = [256, 256],
        kernel_size: int = 3,
        dropout: float = 0.3,
...
class HAVIDSemanticAlignmentTrainer:
    ...
    def __init__(
        ...
        self.optimizer = torch.optim.AdamW([
            {'params': tcn_params, 'lr': learning_rate, 'weight_decay': 1e-4},
            {'params': projector_params, 'lr': learning_rate * 1.5, 'weight_decay': 1e-3}
        ], weight_decay=1e-4)
